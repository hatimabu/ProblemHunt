...
const p=checked(await a.from('community_problems').insert({category_id:category,title:'[Pilot test] Reputation reversals',symptom:'Synthetic fault',environment:{description:'Fictional test only'},expected_behavior:'Success',actual_behavior:'Failure',visibility:'public'}).select().single(),'Problem');
