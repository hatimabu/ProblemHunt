...
if (window.env) {
  ...
  console.log('✅ Loaded config from window.env');
} else {
  console.log('⚠️ window.env not available, using fallback values');
}
...
if (SUPABASE_URL === 'YOUR_SUPABASE_URL' || SUPABASE_ANON_KEY === 'YOUR_SUPABASE_ANON_KEY') {
  console.warn('⚠️ Supabase not configured. App will work with limited functionality.');
}
